...
export const prepareRequest = (dog, id, type) => {
  const newDog = {
    id,
...
export const restartState = (initialState, setState) => {
  setState(initialState)
}

export const typeDogs = (dog) => {
